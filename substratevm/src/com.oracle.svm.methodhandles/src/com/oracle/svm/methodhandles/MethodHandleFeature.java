...
public class MethodHandleFeature implements Feature {
    ...
    public void duringSetup(DuringSetupAccess access) {
        ...
        lambdaFormNames.setAccessible(true);
        lambdaFormArity = ReflectionUtil.lookupField(lambdaFormClass, "arity");
        lambdaFormArity.setAccessible(true);
        ...
        nameFunction.setAccessible(true);
        ...
        namedFunctionMemberName.setAccessible(true);
